...
<h1 class="watermark">this is taxonomy-category_of_brand.php page</h1>
											...
											<div class="cl-blog__list cl-items-container " data-items="2"
                                                ...
                                                <?php 
                                                  ...
                                                  $brand = [
                                                    ...
                                                    'posts_per_page'=>2,
                                                    'tax_query'=>array([
                                                        'taxonomy'=>'category_of_brand',
                                                        'field'=>'term_id', 
                                                        'terms'=>$categoryobj->term_id
                                                                ]),
                                                ];
                                                      $brandarray = new Wp_Query($brand);
                                                ?>
                                                
												<?php while ($brandarray->have_posts()) {
													$brandarray->the_post(); ?>
													<article id=""
