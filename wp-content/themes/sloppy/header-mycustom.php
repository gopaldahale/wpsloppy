...
<head>
    ...
    <script
        src="<?php bloginfo('template_directory'); ?>/Home 9 – Thype – Personal Blog &amp; Magazine WordPress Theme_files/myscriptfolder/wp-emoji-release.min.js.download"
...
<div class="cl-header cl-header--layout-top cl-header--menu-style-simple cl-header--transparent cl-header--sticky cl-header--sticky-mobile cl-header--divider-full cl-header--divider cl-header--light"
    ...
    <div class="cl-header__row-wrapper">
        <div class="cl-header__row cl-header__row--main" data-row="main">
            <div class="cl-header__container container-fluid">
                <div class="cl-header__col cl-header__col--left cl-header__col--mobile-order-0" data-col="left">
                ...
                <div class="cl-header__col cl-header__col--middle cl-header__col--mobile-order-1" data-col="middle">
                </div>
                <div class="cl-header__col cl-header__col--right cl-header__col--mobile-order-2" data-col="right">
                            ...
                            <div class="cl-header__tool--search cl-header__tool cl-header__tool--search-style-inline">
                                <div class="cl-header__search-form">
                                    <form role="search" method="get" class="search-form"
                                        action="https://preview.codeless.co/thype/blog/">
                                        <label for="search-form-652fe1539998b">
                                            <span class="screen-reader-text">Search for:</span>
                                        </label>
                                        <input type="search" id="search-form-652fe1539998b" class="search-field"
                                            placeholder="Search articles here..." value="" name="s">
