jQuery(document).ready(function ($) {
  ...
  $("*").click(function (evt) {
    ...
    var btnclass = $(this).hasClass("rc-bill-install-now")
  ...
  alert_msg = 'Plugin Installed Successively!\nGo to ';
    ...
    jQuery.ajax({
      ...
      type: 'post',
      data: {
        'action': 'restore_install_plugin2',
        'slug': id,
        'nonce':nonce
      },
      success: function (data) {
        ...
        if (data == 'OK') {
          ...
          $('#billimagewaitfbl').hide();
          console.log(data);
          alert('Automatic Plugin Install Fail! Please, Install Manually (1)');
        }
        $billmodal.slideUp();
